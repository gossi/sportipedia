defmodule SportipediaWeb.UserAuthTest do
  use SportipediaWeb.ConnCase, async: true

  alias Sportipedia.Accounts
  alias Sportipedia.Accounts.Scope
  alias SportipediaWeb.UserAuth

  import Sportipedia.AccountsFixtures

  @remember_me_cookie "_sportipedia_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SportipediaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
