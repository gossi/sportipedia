defmodule Sportipedia.Catalog.Equipment.Apparatus.ApparatusReadModel do
  @moduledoc """
  Represents an apparatus in the catalog, projected from events that catalog, edit, and archive apparatuses.
  """
  ...
  @doc """
  Validates and prepares the apparatus read model for insertion.
  """
  ...
  @doc """
  Validates and prepares the apparatus read model for partial updates.
  """
