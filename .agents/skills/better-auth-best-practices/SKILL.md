...
5. Run `ppx @better-auth/cli@latest migrate`
...
### CLI Commands
- `ppx @better-auth/cli@latest migrate` - Apply schema (built-in adapter)
- `ppx @better-auth/cli@latest generate` - Generate schema for Prisma/Drizzle
- `ppx @better-auth/cli mcp --cursor` - Add MCP to AI tools
